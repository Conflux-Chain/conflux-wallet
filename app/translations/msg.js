...
export default {
  ...
  zh: {
    ...
    'Invalid seed': '无效的 Seed',
    'Please enter keystore password': '请输入 keystore 的密码',
    Password: '密码',
    'Wallet Locked': '钱包已锁定',
    'Wallet Already unlocked': '钱包已解锁',
    'No keystore to unlock': '没有 keystore 可以用于解锁',
    'Invalid Password': '无效的密码',
    'Unlock wallet error': '解锁钱包错误',
    'No keystore defined': '没有 keystore 定义',
    'Existing keystore present  - aborting load form localStorage':
      '当前存在 keystore，中止从 localStorage 中加载',
    'No keystore found in localStorage': '在本地缓存中未找到 keystore',
