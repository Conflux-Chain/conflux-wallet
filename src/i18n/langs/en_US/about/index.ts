export default {
  ...
  contain2:
    'The Conflux Foundation issues FC on the promise of prioritizing the FC-CFX swap after the expiration of lock-up periods on Foundation’s ecosystem funds. Both locked and available FC balance are eligible for the mainnet tokenswap. Note that the Foundation reserves the right to investigate and reject a swap request if the FC on the subject is involved in illegal activities or violations of the community code-of-conduct. Details for the exchange process will be released soon.',
  contain3:
